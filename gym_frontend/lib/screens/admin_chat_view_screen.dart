...
class AdminChatViewScreen extends StatefulWidget {
  const AdminChatViewScreen({Key? key}) : super(key: key);
  ...
  Future<void> _loadConversations() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        _showError('Failed to load conversations');
      }
    } catch (e) {
      setState(() {
        _isLoading = false;
...
class AdminChatMessagesScreen extends StatefulWidget {
  ...
  @override
  _AdminChatMessagesScreenState createState() =>
      _AdminChatMessagesScreenState();
}
