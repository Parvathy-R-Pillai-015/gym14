...
# Create higher calorie muscle gain templates
templates_to_create = [
    {
        'name': 'Muscle Gain - Vegan Very High (2500-3000)',
        'goal_type': 'muscle_gain',
        'calorie_min': 2500,
        'calorie_max': 3000,
        'description': 'High protein vegan diet for muscle gain (2500-3000 calories)',
        'meals_data': json.dumps({
            ...
            'snack2': {'items': ['Protein Smoothie with Oat Milk', 'Nuts Mix (50g)'], 'calories': 400},
            'dinner': {'items': ['Lentil Pasta (200g)', 'Tofu Stir-fry (150g)', 'Vegetables'], 'calories': 600},
        })
    },
    {
        'name': 'Muscle Gain - Vegetarian Very High (2500-3000)',
        'goal_type': 'muscle_gain',
        'calorie_min': 2500,
        'calorie_max': 3000,
        'description': 'High protein vegetarian diet for muscle gain (2500-3000 calories)',
        'meals_data': json.dumps({
    ...
    {
        'name': 'Muscle Gain - Non-Veg Very High (2500-3000)',
        'goal_type': 'muscle_gain',
        'calorie_min': 2500,
        'calorie_max': 3000,
        'description': 'High protein non-veg diet for muscle gain (2500-3000 calories)',
        'meals_data': json.dumps({
