...
def update_user_plan(email):
    ...
    if 'Vegan' in plan.plan_name:
        template_name = 'Muscle Gain - Vegan Very High (2500-3000) - 7 Day Varied'
    elif 'Vegetarian' in plan.plan_name:
        template_name = 'Muscle Gain - Vegetarian Very High (2500-3000) - 7 Day Varied'
    else:
        template_name = 'Muscle Gain - Non-Veg Very High (2500-3000) - 7 Day Varied'
